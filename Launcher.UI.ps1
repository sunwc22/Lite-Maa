...
function New-TaskRow {
    ...
    $check.Size = New-Object System.Drawing.Size -ArgumentList 205, 30
    ...
    $gear.Location = New-Object System.Drawing.Point -ArgumentList 236, ($Y + 1)
    $gear.Size = New-Object System.Drawing.Size -ArgumentList 36, 28
    ...
    $gear.Font = New-Object System.Drawing.Font -ArgumentList "Microsoft YaHei UI", 12, ([System.Drawing.FontStyle]::Bold)
...
# Removed top-left brand label per request.
...
# Removed top-right running-task text per request.
...
# Removed decorative/fake top-right control text per request.
...
# Removed top-right profile card text per request.
...
# Three-column layout inspired by MAA:
# left = task list and run controls; middle = selected task settings; right = log output.
$taskPanel = New-Object System.Windows.Forms.Panel
$taskPanel.Dock = [System.Windows.Forms.DockStyle]::Fill
$taskPanel.Margin = New-Object System.Windows.Forms.Padding -ArgumentList 0, 0, 12, 0
...
$leftLayout.BackColor = $appBg
$leftLayout.RowStyles.Add((New-Object System.Windows.Forms.RowStyle([System.Windows.Forms.SizeType]::Percent, 100))) | Out-Null
$leftLayout.RowStyles.Add((New-Object System.Windows.Forms.RowStyle([System.Windows.Forms.SizeType]::Absolute, 164))) | Out-Null
$taskPanel.Controls.Add($leftLayout)

$taskCard = New-Object System.Windows.Forms.Panel
$taskCard.Dock = [System.Windows.Forms.DockStyle]::Fill
$taskCard.Margin = New-Object System.Windows.Forms.Padding -ArgumentList 0, 0, 0, 10
$taskCard.Padding = New-Object System.Windows.Forms.Padding -ArgumentList 8
$taskCard.BackColor = $cardBg
$leftLayout.Controls.Add($taskCard, 0, 0)
Set-CardStyle $taskCard

$taskBottomPanel = New-Object System.Windows.Forms.Panel
$taskBottomPanel.Dock = [System.Windows.Forms.DockStyle]::Fill
$taskBottomPanel.Margin = New-Object System.Windows.Forms.Padding -ArgumentList 0
$taskBottomPanel.BackColor = $cardBg
$leftLayout.Controls.Add($taskBottomPanel, 0, 1)
Set-CardStyle $taskBottomPanel

$taskTitle = New-Object System.Windows.Forms.Label
$taskTitle.Text = "Automation Tasks"
...
$taskTitle.Size = New-Object System.Drawing.Size -ArgumentList 220, 28
$taskCard.Controls.Add($taskTitle)

$taskHint = New-Object System.Windows.Forms.Label
$taskHint.Text = "Click ... to configure task parameters."
$taskHint.Font = New-Object System.Drawing.Font -ArgumentList "Microsoft YaHei UI", 9
$taskHint.ForeColor = $mutedText
$taskHint.Location = New-Object System.Drawing.Point -ArgumentList 24, 48
$taskHint.Size = New-Object System.Drawing.Size -ArgumentList 240, 40
$taskCard.Controls.Add($taskHint)

$startWakeRow = New-TaskRow -Parent $taskCard -Text "Start Wake" -Y 78 -Checked $true -HasSettings $true
$joinDuelRow = New-TaskRow -Parent $taskCard -Text "Join Duel Event" -Y 122 -Checked $true -HasSettings $true
...
$settingsPanel.Margin = New-Object System.Windows.Forms.Padding -ArgumentList 0, 0, 12, 0
$settingsPanel.BackColor = $cardBg
$settingsPanel.AutoScroll = $true
$contentLayout.Controls.Add($settingsPanel, 1, 0)
...
function Show-StartWakeSettings {
    $settingsPanel.AutoScrollPosition = New-Object System.Drawing.Point -ArgumentList 0, 0
    $settingsTitle.Text = "Start Wake"
...
$logPanel.Margin = New-Object System.Windows.Forms.Padding -ArgumentList 0
$contentLayout.Controls.Add($logPanel, 2, 0)
